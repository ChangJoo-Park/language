...
The dynamic type of $o$ implements \code{Future<$T$>},
where $T$ is the future value type of $f$
computed from its actual return type (\ref{actualTypes}).
...
\LMHash{}%
An assignment binds a variable to an object,
